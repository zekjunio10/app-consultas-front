...
function renderMessagesList(list, target) {
  ...
  list.forEach(m => {
    ...
    card.appendChild(el("div", {}, ["Número: ", el("strong", {}, m.phoneNumber||m.numero )]));
...
async function screenMyChips(){
  ...
  if(!list.length){ wrap.innerHTML="<div>Nenhum chip encontrado.</div>"; }
    ...
    list.forEach(c=>{
      ...
      card.appendChild(el("div", {}, ["Número: ", el("strong", {}, c.phoneNumber)]));
      card.appendChild(el("div", {}, ["ActivationID: ", el("strong", {}, c.activationId)]));
      card.appendChild(el("div", {}, ["Operadora: ", el("strong", {}, c.operator)]));
      card.appendChild(el("div", {}, ["País: ", el("strong", {}, c.country)]));
...
async function buildUI(){
  ...
  btn.onclick=async()=>{
    ...
    try{
      ...
      card.appendChild(el("div",{},["Número: ", el("strong",{}, d.phoneNumber)]));
